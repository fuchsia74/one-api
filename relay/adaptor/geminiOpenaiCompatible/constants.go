...
var ModelRatios = map[string]adaptor.ModelConfig{
	...
	"gemini-2.5-flash-lite-preview-09-25": {Ratio: 0.1 * ratio.MilliTokensUsd, CompletionRatio: 4},
	...
	"gemini-2.5-flash-preview-09-25":      {Ratio: 0.3 * ratio.MilliTokensUsd, CompletionRatio: 2.5 / 0.3},
	"gemini-2.5-flash-image":              {Ratio: 0.3 * ratio.MilliTokensUsd, CompletionRatio: 2.5 / 0.3, ImagePriceUsd: 0.039 * ratio.ImageUsdPerPic},
